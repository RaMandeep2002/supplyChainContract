...
*/
  ...
  */
    function receivedItemByDistributor(
        uint256 _productCode
    )
        public
        onlyDistributor // check _msgSender() belongs to DistributorRole
  ...
  */
    function processedItemByDistributor(
        uint256 _productCode,
        uint256 slices
    )
        public
  ...
  */
    function packageItemByDistributor(
        uint256 _productCode
    )
        public
        onlyDistributor // check _msgSender() belongs to DistributorRole
  ...
  */
    function sellItemByDistributor(
        uint256 _productCode,
        uint256 _price
    )
        public
  ...
  */
    function shippedItemByDistributor(
        uint256 _productCode
    )
        public
        onlyDistributor // check _msgSender() belongs to DistributorRole
  ...
  */
    function receivedItemByRetailer(
        uint256 _productCode
    )
        public
        onlyRetailer // check _msgSender() belongs to RetailerRole
  ...
  */
    function purchaseItemByConsumer(
        uint256 _productCode
    )
        public
        payable
    ...
    function getItemDetailsExtended(
        uint256 _productCode
    )
        public
        view
